    ...
    <header class="bg-dark py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="text-center text-white">
                ...
                <p class="lead fw-normal text-white-50 mb-0">With Moralex</p>
            </div>
        </div>
    </header>
    <!-- Section-->
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body p-4">
                            <div class="text-center">
                               ...
                               <b> <?php if($product->discount > 0): ?> <del><?php echo e($product->price); ?> ₪</del> <?php endif; ?> <?php echo e($product->price - $product->discount); ?> ₪</b> 
                            </div>
                        </div>
                        <!-- Product actions-->
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                            <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="<?php echo e(route('product.index',$product->id)); ?>">View options</a></div>
                        </div>
                    </div>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Desktop\Laravel\Moralex\resources\views/index.blade.php ENDPATH**/ ?>