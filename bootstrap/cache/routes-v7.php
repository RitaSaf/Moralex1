...
app('router')->setCompiledRoutes(
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        array (
          0 => 
          array (
            '_route' => 'generated::z1UFlSclQ5tGi5QQ',
          ),
          1 => NULL,
          2 => 
          array (
    ...
    2 => 
    array (
      0 => '{^(?|/product/([^/]++)(*:24)|/add\\-to\\-cart/([^/]++)(*:54)|/update\\-qty/([^/]++)(*:82)|/delete\\-product/([^/]++)(*:114))/?$}sDu',
    ),
    3 => 
    array (
      24 => 
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\CartController@update_qty',
        'controller' => 'App\\Http\\Controllers\\CartController@update_qty',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\CartController@delete_product',
        'controller' => 'App\\Http\\Controllers\\CartController@delete_product',
        'namespace' => NULL,
        'prefix' => '',
        'where' => 
        array (
